...
{
    internal static void RegisterInstance<TInstance>(this ServiceController controller, object id, TInstance instance) => controller.RegisterAccessor(new WeakSingletonServiceAccessor(ServiceId.From<TInstance>(id), instance));
